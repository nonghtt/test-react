...
- 학습자 시작 수준 (2026-09-17): React 튜토리얼 진행 중, TS 사용 가능
- 방식: 짧고 자주 (실습 1개 = 30~60분), 힌트 최소
- TypeScript는 보조 — 타입 문제는 React 이해를 막을 때만 다룸
